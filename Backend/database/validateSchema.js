...
const validate = async () => {
  ...
  try {
    ...
    const checks = [
      ...
      "SELECT id,vin,brand,model,price,status,description,updated_at FROM vehicles LIMIT 0",
      "SELECT id,name,sku,price,stock,is_active,updated_at FROM accessories LIMIT 0",
