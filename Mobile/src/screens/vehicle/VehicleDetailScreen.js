...
const styles = StyleSheet.create({
  ...
  stock: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 7, backgroundColor: '#EAF8F2', borderRadius: 12 }, stockDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: COLORS.success, marginRight: 6 }, stockText: { color: '#16805B', fontSize: 11.5, fontWeight: '700' },
  ...
  descriptionCard: { backgroundColor: COLORS.surface, borderRadius: 16, borderWidth: 1, borderColor: COLORS.border, padding: 16 }, description: { color: COLORS.muted, fontSize: 13.5, lineHeight: 21 },
