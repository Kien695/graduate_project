    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      <View style={styles.screen}>
        ...
        >
          ...
          <OrderConfirmCard vehicle={vehicle} />
          ...
          <View style={styles.notice}>
            ...
            <Text style={styles.noticeText}>
              Xe sẽ được chuyển sang trạng thái giữ chỗ sau khi đặt hàng. Nhân
              viên sẽ liên hệ để xác nhận đơn.
            </Text>
          </View>
        </ScrollView>
...
function CustomerRow({ icon, label, value, last, colors }) {
  const styles = getStyles(colors);
  return (
    <View style={[styles.customerRow, last && styles.last]}>
...
const getStyles = (colors) =>
  StyleSheet.create({
    ...
    label: { color: colors.muted, fontSize: 13, marginLeft: 9 },
    value: {
      color: colors.text,
      fontSize: 13,
      fontWeight: "700",
    ...
    error: { color: colors.price, fontSize: 13, lineHeight: 19, marginTop: 14 },
    notice: {
      flexDirection: "row",
