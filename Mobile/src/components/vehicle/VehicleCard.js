    ...
    >
      ...
      <View style={[styles.body, !featured && styles.listBody]}>
        ...
        <Text style={styles.meta}>
          {vehicle.year} · {vehicle.color || "Chưa cập nhật"}
        </Text>
...
const getStyles = (colors) =>
  StyleSheet.create({
    ...
    featuredCard: { width: 270, marginRight: 14, marginBottom: 8 },
    listCard: {
      minHeight: 124,
      marginBottom: 14,
      flexDirection: "row",
    ...
    meta: { color: colors.muted, fontSize: 12.5, marginTop: 5 },
    price: {
      color: colors.price,
      fontSize: 15,
      fontWeight: "800",
