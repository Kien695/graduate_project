    ...
    >
      <View style={styles.modal}>
        <View style={styles.header}>
          <TouchableOpacity style={styles.circle} onPress={onRequestClose}>
        ...
        <Pressable
          style={styles.stage}
          onPress={() => setScale((value) => (value === 1 ? 2 : 1))}
        >
          <Image
        ...
        <View style={styles.zoom}>
          <TouchableOpacity
            ...
            onPress={() => setScale((value) => Math.max(1, value - 0.5))}
          >
          ...
          <TouchableOpacity
            style={styles.zoomButton}
            onPress={() => setScale((value) => Math.min(3, value + 0.5))}
          >
            <Text style={styles.zoomText}>+</Text>
          </TouchableOpacity>
        </View>
...
const getStyles = (colors) =>
  StyleSheet.create({
    modal: { flex: 1, backgroundColor: "#050609" },
    header: {
      position: "absolute",
      zIndex: 3,
      top: 24,
    ...
    zoomText: { color: colors.white, fontSize: 24 },
    zoomValue: {
      color: colors.white,
      width: 58,
      textAlign: "center",
