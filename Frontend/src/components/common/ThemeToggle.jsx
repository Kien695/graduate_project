...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      <span
        className={`absolute left-1 grid h-7 w-7 place-items-center rounded-full bg-white shadow-md transition-transform ${isDark ? "translate-x-7 bg-slate-900" : "translate-x-0"}`}
      >
