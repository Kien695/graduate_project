export const Icon = ({ name, className = "h-5 w-5" }) => {
  const paths = {
    ...
    car: "M5 17h14l-1-6-2-4H8l-2 4-1 6Zm0 0v2m14-2v2M7 13h10M9 10h6",
    box: "M4 7l8-4 8 4-8 4-8-4Zm0 0v10l8 4 8-4V7M12 11v10",
    orders: "M6 4h12v16H6V4Zm3 4h6m-6 4h6m-6 4h4",
    contract: "M5 3h10l4 4v14H5V3Zm10 0v5h4M8 12h8m-8 4h6",
    inspect: "M9 3h6l1 2h3v16H5V5h3l1-2Zm0 10 2 2 4-5",
    users:
      "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2m7-10a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm8-3a3 3 0 0 1 0 6m4 7v-2a4 4 0 0 0-3-3",
